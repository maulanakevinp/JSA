...
class IjinKerjaDiKetinggianController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $ijinKerja = IjinKerjaDiKetinggian::create([
            ...
            'area_kerja_perlu_dipasang_barikade'                                => $request->area_kerja_perlu_dipasang_barikade,
            'keterangan_pekerja_bekerja_sendiri'                                => $request->keterangan_pekerja_bekerja_sendiri,
            'keterangan_area_kerja_perlu_dipasang_barikade'                     => $request->keterangan_area_kerja_perlu_dipasang_barikade,

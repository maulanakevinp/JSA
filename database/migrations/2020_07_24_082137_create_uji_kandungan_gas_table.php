...
class CreateUjiKandunganGasTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('uji_kandungan_gas', function (Blueprint $table) {
            ...
            $table->string('waktu_pelaksanaan_pekerjaan_setiap1', 64)->nullable();
            ...
            $table->string('waktu_pelaksanaan_pekerjaan_setiap2', 64)->nullable();
            ...
            $table->string('waktu_pelaksanaan_pekerjaan_setiap3', 64)->nullable();
            $table->timestamps();
        });
    }

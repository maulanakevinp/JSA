...
class CreateIjinKerjaPanasTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('ijin_kerja_panas', function (Blueprint $table) {
            ...
            $table->boolean('semua_saluran_drain_dan_kerangan_pada_jarak_15m')->nullable()->default(0);
            $table->boolean('bahan_mudah_terbakar_diamankan')->nullable()->default(0);
            $table->boolean('alat_pemadam_kebakaran_siap_sedia')->nullable()->default(0);
            $table->boolean('petugas_pemadam_kebakaran_siap_sedia')->nullable()->default(0);
            $table->boolean('semua_peralatan_las_telah_diamankan')->nullable()->default(0);
            $table->boolean('pekerjaan_harus_terus_dibasahi_dengan_air')->nullable()->default(0);
            $table->boolean('perlu_dengan_ijin_kerja_yang_lain')->nullable()->default(0);
            $table->boolean('semua_mesin_telah_diamankan')->nullable()->default(0);
            $table->boolean('semua_pekerjaan_telah_disetujui_untuk_penggalian')->nullable()->default(0);

    ...
    <div class="col-md-6 mb-3">
        ...
        <div class="pl-lg-4">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="nama_pelaksana_pekerjaan" id="nama_pelaksana_pekerjaan" placeholder="Masukkan Nama ...">
            </div>
        </div>
        <div class="pl-lg-4">
            <div class="form-group">
                <label class="form-control-label" for="jabatan_pelaksana_pekerjaan">Jabatan</label>
                <input class="form-control" type="text" name="jabatan_pelaksana_pekerjaan" id="jabatan_pelaksana_pekerjaan" placeholder="Masukkan Jabatan ...">
            </div>
        </div>
        <div class="pl-lg-4">
            <div class="form-group">
                <label class="form-control-label" for="tanggal_pelaksana_pekerjaan">Tanggal</label>
                <input class="form-control" type="date" name="tanggal_pelaksana_pekerjaan" id="tanggal_pelaksana_pekerjaan" placeholder="Masukkan Tanggal ...">
            </div>
        </div>
    </div>
    <div class="col-md-6 mb-3">
        ...
        <div class="pl-lg-4">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="nama_penanggung_jawab_area" id="nama_penanggung_jawab_area" placeholder="Masukkan Nama ...">
            </div>
        </div>
        <div class="pl-lg-4">
            <div class="form-group">
                <label class="form-control-label" for="jabatan_penanggung_jawab_area">Jabatan</label>
                <input class="form-control" type="text" name="jabatan_penanggung_jawab_area" id="jabatan_penanggung_jawab_area" placeholder="Masukkan Jabatan ...">
            </div>
        </div>
        <div class="pl-lg-4">
            <div class="form-group">
                <label class="form-control-label" for="tanggal_penanggung_jawab_area">Tanggal</label>
                <input class="form-control" type="date" name="tanggal_penanggung_jawab_area" id="tanggal_penanggung_jawab_area" placeholder="Masukkan Tanggal ...">
            </div>
        </div>
    </div>
</div>

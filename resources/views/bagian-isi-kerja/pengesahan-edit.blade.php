    ...
    <div class="col-md-6 mb-3">
        ...
        <div class="pl-lg-4">
            <div class="form-group">
                ...
                <input class="form-control form-control-alternative @error('nama_pelaksana_pekerjaan') is-invalid @enderror" type="text" name="nama_pelaksana_pekerjaan" id="nama_pelaksana_pekerjaan" placeholder="Masukkan Nama ..." value="{{ old('nama_pelaksana_pekerjaan', $ijinKerja->pengesahan->nama_pelaksana_pekerjaan) }}">
                @error('nama_pelaksana_pekerjaan')
        ...
        <div class="pl-lg-4">
            <div class="form-group">
                ...
                <input class="form-control form-control-alternative @error('jabatan_pelaksana_pekerjaan') is-invalid @enderror" type="text" name="jabatan_pelaksana_pekerjaan" id="jabatan_pelaksana_pekerjaan" placeholder="Masukkan Jabatan ..." value="{{ old('jabatan_pelaksana_pekerjaan', $ijinKerja->pengesahan->jabatan_pelaksana_pekerjaan) }}">
                @error('jabatan_pelaksana_pekerjaan')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                @enderror
        ...
        <div class="pl-lg-4">
            <div class="form-group">
                ...
                <input class="form-control form-control-alternative @error('tanggal_pelaksana_pekerjaan') is-invalid @enderror" type="date" name="tanggal_pelaksana_pekerjaan" id="tanggal_pelaksana_pekerjaan" placeholder="Masukkan Tanggal ..." value="{{ old('tanggal_pelaksana_pekerjaan', $ijinKerja->pengesahan->tanggal_pelaksana_pekerjaan) }}">
    ...
    <div class="col-md-6 mb-3">
        ...
        <div class="pl-lg-4">
            <div class="form-group">
                ...
                <input class="form-control form-control-alternative @error('nama_penanggung_jawab_area') is-invalid @enderror" type="text" name="nama_penanggung_jawab_area" id="nama_penanggung_jawab_area" placeholder="Masukkan Nama ..." value="{{ old('nama_penanggung_jawab_area', $ijinKerja->pengesahan->nama_penanggung_jawab_area) }}">
                @error('nama_penanggung_jawab_area')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                @enderror
        ...
        <div class="pl-lg-4">
            <div class="form-group">
                ...
                @error('jabatan_penanggung_jawab_area')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                @enderror
        ...
        <div class="pl-lg-4">
            <div class="form-group">
                ...
                @error('tanggal_penanggung_jawab_area')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                @enderror

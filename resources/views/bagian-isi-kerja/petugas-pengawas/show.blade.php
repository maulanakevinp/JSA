    ...
    <div class="col-md-6 mb-3">
        ...
        <div class="pl-lg-4">
            <div class="form-group">
                ...
                <input disabled class="form-control form-control-alternative @error('nama_petugas_isolasi_listrik') is-invalid @enderror" type="text" name="nama_petugas_isolasi_listrik" id="nama_petugas_isolasi_listrik" placeholder="Masukkan Nama ..." value="{{ old('nama_petugas_isolasi_listrik', $ijinKerja->petugasPengawas->nama_petugas_isolasi_listrik) }}">
            </div>
        </div>
        <div class="pl-lg-4">
            <div class="form-group">

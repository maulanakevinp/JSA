<div class="card bg-secondary shadow h-100 mb-3">
    <div class="card-header font-weight-bold">SUMBER BAHAYA ALAT</div>
    <div class="card-body">
        <form class="form" action="javascript:;" method="post" data-url="{{ route("sumberBahayaAlat.update", $ijinKerja->sumber_bahaya_alat_id) }}">
            @csrf @method('patch')
            <div class="row">

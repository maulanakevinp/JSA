...
@section('title', 'Kelola Ijin Kerja Galian')
...
@if (Request::segment(1) == 'ijin-kerja-galian-grid')
                    ...
                    <div class="card-header d-inline-flex justify-content-between">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                <a target="_blank" href="{{ route('ijin-kerja-galian.show',$item) }}" class="dropdown-item"><i class="fas fa-fw fa-eye"> Detail</i></a>
                                <a href="{{ route('ijin-kerja-galian.cetak',$item) }}" class="dropdown-item"><i class="fas fa-fw fa-print"> Cetak</i></a>
                                @can('hse')
                                    <a href="{{ route('ijin-kerja-galian.edit',$item) }}" class="dropdown-item"><i class="fas fa-fw fa-edit"> Edit</i></a>
                    ...
                    <tbody>
                        @forelse ($ijinKerja as $item)
                            <tr>
                                ...
                                <td>
                                    @can('hse')
                                        <a href="{{ route('ijin-kerja-galian.show',$item) }}" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Detail"><i class="fas fa-eye"></i></a>
                                        <a href="{{ route('ijin-kerja-galian.edit',$item) }}" class="btn btn-sm btn-success" data-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
                                        <a href="{{ route('ijin-kerja-galian.cetak',$item) }}" class="btn btn-sm btn-info" data-toggle="tooltip" title="Cetak"><i class="fas fa-print"></i></a>
                                    ...
                                    @endcan
                                    @can('kontraktor')
                                        <a href="{{ route('ijin-kerja-galian.show',$item) }}" class="btn btn-sm btn-neutral" data-toggle="tooltip" title="Detail"><i class="fas fa-eye"></i></a>
                                    @endcan
                                </td>
                            </tr>
                        @empty
    ...
    <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
        <div class="modal-content bg-gradient-danger">
            ...
            <div class="modal-header">
                <h6 class="modal-title" id="modal-title-delete">Hapus Ijin Kerja Galian?</h6>
            ...
            <div class="modal-body">
                ...
                <div class="py-3 text-center">
                    ...
                    <p>Menghapus ijin kerja Galian akan menghapus semua data yang dimilikinya</p>
...
<script>
    $(document).ready(function(){
        ...
        $('.hapus').on('click', function(){
            ...
            $('#form-hapus').attr('action', $("meta[name='base-url']").attr('content') + '/ijinKerjaGalian/' + $(this).data('id'));
        });
    });
</script>
@endpush

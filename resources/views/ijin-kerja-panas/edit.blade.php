                ...
                <div class="pl-lg-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <div class="input-group-text">
                                    <input type="checkbox" name="jalur_diisolasi_dengan_kerangan_dikunci" value="1" {{ $ijinKerja->jalur_diisolasi_dengan_kerangan_dikunci == 1 ? 'checked' : '' }} data-toggle="tooltip" title="Centang untuk status (YA)">
                                </div>
                            </div>
                            <input type="text" class="form-control" value="{{ $ijinKerja->keterangan_jalur_diisolasi_dengan_kerangan_dikunci }}" name="keterangan_jalur_diisolasi_dengan_kerangan_dikunci" data-placeholder="Masukkan Keterangan ...">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <div class="input-group-text">
                                    <input type="checkbox" name="jalur_diisolasi_dengan_diberi_label" value="1" {{ $ijinKerja->jalur_diisolasi_dengan_diberi_label == 1 ? 'checked' : '' }} data-toggle="tooltip" title="Centang untuk status (YA)">
                                </div>
                            </div>
                            <input type="text" class="form-control" value="{{ $ijinKerja->keterangan_jalur_diisolasi_dengan_diberi_label }}" name="keterangan_jalur_diisolasi_dengan_diberi_label" data-placeholder="Masukkan Keterangan ...">
                        </div>
                    </div>
                </div>
                <div class="form-group">
